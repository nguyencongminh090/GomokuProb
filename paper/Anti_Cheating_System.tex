...
% Version 2 — Revised with Skill Stratification, Multi-Game Profile Analysis,
%              Sample Size Theory, and Experimental Observations
% =============================================================================
...
false-positive problem arising from strong legitimate players, and a formal
\emph{multi-game profile analysis} grounded in confidence-interval theory
and hypothesis testing for population-level inference. A formal likelihood
ratio test grounded in Neyman--Pearson theory provides false-positive rate
control. We describe the complete mathematical formulation, the system
architecture for engine integration, and the classification decision
boundaries, and report preliminary experimental observations that motivate
...
skill stratification, profile analysis.
\end{abstract}
...
\begin{equation}
    A(\Delta, C) = \begin{cases}
        ...
        \exp\!\left(-5 \Delta (1 - 0.3C)\right) & \text{otherwise.}
    \end{cases}
\end{equation}
...
\begin{itemize}
    ...
    \item \textbf{Empirical calibration:} Fitting all model parameters via EM,
          MCMC, or variational inference on large labeled datasets. KS and
          Anderson--Darling tests should validate distributional assumptions.
    ...
    \item \textbf{Systematic empirical evaluation:} Benchmarking on three
          ...
          suspected games---with full ROC curve, AUC, precision--recall, and
